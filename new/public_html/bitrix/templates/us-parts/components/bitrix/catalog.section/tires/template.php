            ...
            <div class="product-item">
                ...
                <div class="row">
                    <div class="left-block">
                        <div class="row">
                            <div class="product-image">
                                <div class="wrapper">
                                    <img data-image="<?=$item['DETAIL_PICTURE']['SRC']?>" src="<?=$item['DETAIL_PICTURE']['SRC']?>" alt="product image">
                                </div>
                            </div>
                            <div class="product-info">
                                <p class="info-title"><b>Характеристики:</b></p>
                                <ul>
                                    <?
                                    $attr = [];;
                                ...
                                <a class="btn transparent small blue" href="<?=$item['DETAIL_PAGE_URL']?>">Смотреть всю информацию</a>
                            </div>
                        </div>
                    </div>
                    <div class="right-block">
                        ...
                        <button class="btn small blue mobile-more"><a href="<?=$item['DETAIL_PAGE_URL']?>">Подробнее</a></button>
                    </div>
                </div>
            </div>
        <? }
