...
<script id="basket-item-template" type="text/html">
    <div class="table-row basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
        ...
        {{/SHOW_RESTORE}}
        {{^SHOW_RESTORE}}
        <div class="table-body-cell product-name display-flex" id="basket-item-height-aligner-{{ID}}">
            ...
            <div class="product-meta">
                ...
                {{#DETAIL_PAGE_URL}}
                    <a href="{{DETAIL_PAGE_URL}}" class="basket-item-image-link">
                {{/DETAIL_PAGE_URL}}
                    <p class="product-meta-name">{{NAME}}</p>
                {{#DETAIL_PAGE_URL}}
                    </a>
                {{/DETAIL_PAGE_URL}}
                    <a href="{{SECTION_PAGE_URL}}">
                        <p class="product-meta-category">{{CATEGORY_NAME}}</p>
                    </a>
                    <p class="product-article">Артикул: <span class="light"><a href="/search?code={{{ARTICLE}}}"> {{{ARTICLE}}}</a></span></p>
            </div>
        </div>
        <div class="table-body-cell product-price">
            <div class="basket-item-price-current">
                                <span class="basket-item-price-current-text" id="basket-item-price-{{ID}}">
                                    <p><span class="bold">{{{PRICE_FORMATED}}}</span></p>
                                </span>
                {{#SHOW_LOADING}}
                <div class="basket-items-list-item-overlay"></div>
                {{/SHOW_LOADING}}
        ...
        <div class="table-body-cell product-quantity {{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}" data-entity="basket-item-quantity-block">
            <button type="button" class="quantity-change quantity-minus" data-entity="basket-item-quantity-minus">
                <i class="fa fa-minus" aria-hidden="true"></i>
            </button>
            <input type="text" name="product-quantity" class="input-product-quantity" data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field" id="basket-item-quantity-{{ID}}" value="{{QUANTITY}}" {{#NOT_AVAILABLE}} disabled="disabled" {{/NOT_AVAILABLE}}>
            <button type="button" class="quantity-change quantity-plus" data-entity="basket-item-quantity-plus">
                <i class="fa fa-plus" aria-hidden="true"></i>
            </button>
        </div>
        <div class="table-body-cell product-total<?=(!isset($mobileColumns['SUM']) ? ' hidden-xs' : '')?>">
            <p class="price-total basket-item-price-current-text" id="basket-item-sum-price-{{ID}}"><span class="bold">{{{SUM_PRICE_FORMATED}}}</span></p>
            {{#SHOW_DISCOUNT_PRICE}}
            <p class="price-total"><span class="bold">{{{SUM_DISCOUNT_PRICE_FORMATED}}}</span></p>
            {{/SHOW_DISCOUNT_PRICE}}
            <? if ($useActionColumn) { ?>
                <p class="product-delete" data-entity="basket-item-delete"><i class="fa fa-trash-o" aria-hidden="true"></i> Удалить из корзины</p>
                {{#SHOW_LOADING}}
                <div class="basket-items-list-item-overlay"></div>
                {{/SHOW_LOADING}}
            <? } ?>
