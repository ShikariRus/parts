...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	<div id="basket-root" class="bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		<?
		if (
			$arParams['BASKET_WITH_ORDER_INTEGRATION'] !== 'Y' && in_array('top', $arParams['TOTAL_BLOCK_DISPLAY'])
		)
		{
			?>
			<div class="row">
...
<!--		</div>-->
        <div class="cart">
            <div class="title-section">Моя корзина</div>
            <div class="row">
                <div class="cart-block">
                    <div class="cart-form">
                        <div class="table-head">
                            <div class="table-cell product-name">Товар</div>
                            <div class="table-cell product-price">Цена товара</div>
                            <div class="table-cell product-quantity">Количество</div>
                            <div class="table-cell product-total">Общая цена</div>
                        </div>
    ...
    <script>
        $(function () {
            $('body').on('.clear-cart', 'click', function () {
                $('.product-delete').trigger('click');
