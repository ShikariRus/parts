                ...
                <div class="row">
                    ...
                    <div class="delivery-description">
                        <div class="form-radio">
                            <label for="checkout-payment_<?=$arPaySystem['ID']?>"><input <?=isset($arPaySystem['CHECKED']) ? 'checked' : '' ?> type="radio" id="checkout-payment_<?=$arPaySystem['ID']?>" name="PAY_SYSTEM_ID" value="<?=$arPaySystem['ID']?>"><?=$arPaySystem['NAME']?></label>
                        </div>
                    </div>
                </div>
            </div>
