			...
			?>
				<div class="row">
					...
					foreach ($arSource as $arProperties)
					{
                        ...
                        ||
                        $arProperties["FIELD_NAME"] == 'ORDER_PROP_20'
                        ||
                        $arProperties["FIELD_NAME"] == 'ORDER_PROP_2'
                        ||
                        $arProperties["FIELD_NAME"] == 'ORDER_PROP_3'
                    ) {
                        $class = 'half-width';
                    }else{
                        $class = 'full-width';
...
<!--                        --><?// $arProperties["VALUE"] = $arUser['UF_ADDRESS'] ?>
                    ...
                    elseif ($arProperties["TYPE"] == "TEXTAREA")
                    {
                        ...
                        ?>
                            <textarea class="form-input full-width" style="resize: none" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"><?=$arProperties["VALUE"]?></textarea><?
                    }
