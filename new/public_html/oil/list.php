...
$arSelect = Array();
$arFilter = Array("IBLOCK_ID"=>7,"SECTION_ID"=>$_REQUEST["SECTION_ID"],"ACTIVE"=>"Y");
$res = CIBlockElement::GetList(Array(), $arFilter, false, Array("nPageSize"=>20), $arSelect);
if ($ob = $res->GetNextElement()){ ?>
    <div class="catalog catalog-list">
        <div class="title-section">Каталог масел и автохимии</div>
        <? $APPLICATION->IncludeComponent("bitrix:catalog.section", "oil", Array(
